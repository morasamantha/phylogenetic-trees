...
\begin{figure}
  \begin{tikzpicture}
      \draw
        ...
        (342.0:2) node (9){9};
      \begin{scope}[-]
        \draw (andersoni) to node[] {0.0} (3);
        \draw (barbouri) to node[] {0.03} (2);
        \draw (bishopi) to node[] {0.07} (7);
        \draw (californiense) to node[] {0.04} (6);
        \draw (dumerilii) to node[] {0.02} (4);
        \draw (laterale) to node[] {0.06} (8);
        \draw (mexicanum) to node[] {0.0} (3);
        \draw (talpoideum) to node[] {0.09} (1);
        \draw (texanum) to node[] {0.03} (2);
        \draw (tigrinum) to node[] {0.02} (5);
        \draw (lacertina) to node[] {0.22} (1);
        \draw (1) to node[] {0.02} (7);
        \draw (2) to node[] {0.03} (9);
        \draw (3) to node[] {0.01} (4);
        \draw (4) to node[] {0.01} (5);
        \draw (5) to node[] {0.0} (6);
        \draw (6) to node[] {0.02} (9);
        \draw (7) to node[] {0.0} (8);
